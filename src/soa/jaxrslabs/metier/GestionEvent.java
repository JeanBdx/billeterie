...
public class GestionEvent {
	...
	/**
	 * Fonction qui permet de retourner tous les noms de Zone d'une categorie(d'un evenement) pass� en param�tre 
	 * Elle est appel�e dans le formulaire de r�servation de place 
	 * @param chemin
	 * @param idEvent
	 * @param nomCategorie
	 * @return
	...
	/**
	 * Fonction qui permet de retourner tous les noms des Rang d'une categorie & d'une zone pass� en param�tre 
	 * Elle est appel�e dans le formulaire de r�servation de place 
	 * @param chemin
	 * @param idEvent
	 * @param nomCategorie
	...
	/**
	 * Fonction qui permet de retourner tous les noms des Places d'une categorie & d'une zone & d'un rang pass� en param�tre 
	 * Elle est appel�e dans le formulaire de r�servation de place 
	 * @param chemin
	 * @param idEvent
	 * @param nomCategorie
	...
	/**
	 * Fonction qui recupere tous les evenements stock� dans le fichier /XML/event
	 * @param chemin
	 * @return
	 * @throws IOException
	 */
	...
	/**
	 * Fonction qui permet la réservation d'une place
	 * 
	 * @see Reservation
	 * 
	 * @param chemin
