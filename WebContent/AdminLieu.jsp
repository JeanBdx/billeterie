...
<nav id="mainNav" class="navbar navbar-default navbar-custom navbar-fixed-top">
       ...
       <BR/>
        <form action="CreationLieu" method="post">
            ...
            <div class="form-group row">
                ...
                <div class="col-10">
                    <input class="form-control" type="text" value="" id="label_lieu" name="localisation" required>
                </div>
            </div>
               
                <div class="form-group row">
                    <label for="example-number-input" class="col-2 col-form-label">Nombre de catégories</label>
                    <div class="col-10">
                        <input class="form-control" type="number" name="nbCategorie" id="input_categories" name="input_categories" min="1" required>
                    </div>
                </div>
  ...
  <div class="col-10">
                ...
                <div class="form-group row" id="blocs">
